...
class GithubSource:
    ...
    BOT_REPO_URL = 'https://github.com/Kraots/vystalia'
    ...
    async def get_source(
        ...
        data = ReturnData()
        if cmd is None:
            embed = disnake.Embed(title="Vystalia's GitHub Repository")
        ...
        embed = disnake.Embed(title="Vystalia's Source Link", description=f"{url}")
        embed.add_field(

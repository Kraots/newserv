...
all_age_roles = (
    1102654728720097371, 1102654728720097370, 1102654728707526715,
    1102654728707526714, 1102654728707526713, 1102654728707526712
)
...
age_roles = {
    'vystalia:age_roles:14': 1102654728720097371, 'vystalia:age_roles:15': 1102654728720097370,
    'vystalia:age_roles:16': 1102654728707526715, 'vystalia:age_roles:17': 1102654728707526714,
    'vystalia:age_roles:18': 1102654728707526713, 'vystalia:age_roles:19': 1102654728707526712
}
...
class AgeButtonRoles(disnake.ui.View):
    ...
    @disnake.ui.button(label='14', custom_id='vystalia:age_roles:14', row=0, style=disnake.ButtonStyle.blurple)
    ...
    @disnake.ui.button(label='15', custom_id='vystalia:age_roles:15', row=0, style=disnake.ButtonStyle.blurple)
    ...
    @disnake.ui.button(label='16', custom_id='vystalia:age_roles:16', row=0, style=disnake.ButtonStyle.blurple)
    ...
    @disnake.ui.button(label='17', custom_id='vystalia:age_roles:17', row=1, style=disnake.ButtonStyle.blurple)
    ...
    @disnake.ui.button(label='18', custom_id='vystalia:age_roles:18', row=1, style=disnake.ButtonStyle.blurple)
    ...
    @disnake.ui.button(label='19', custom_id='vystalia:age_roles:19', row=1, style=disnake.ButtonStyle.blurple)
